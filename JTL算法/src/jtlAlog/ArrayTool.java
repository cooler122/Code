...
public class ArrayTool {
	...
	private final int yLength = 3;						//这个的长短或许能控制计算结果的精度（靠需要画多少点来计算出来）
	...
	public void putData(String timeStemp, String responseTime, String version){
		if(index >= 0 && index < xLength){
			dataArray[index][0] = timeStemp;
			dataArray[index][1] = responseTime;
			dataArray[index][2] = version;
			index ++;
